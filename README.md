...
- [x] **Stores data in MongoDB** - Stores games as well as the gameIDCounter, wins, and losses, in mongdb, implemented in database.js and index.js
- [x] **Stores credentials in MongoDB** - Stores login credentials in mongodb, implemented in database.js and index.js
